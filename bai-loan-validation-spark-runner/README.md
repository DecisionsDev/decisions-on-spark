...
All decision events emitted from the ODM Spark application flow through a Kafka/Flink/ELK pipeline. From a BAI installation you see your automated decisions in Business Performance Center as captured below. In addition to the general Decisions dashboard you can make your own more tailored to vertical needs.
