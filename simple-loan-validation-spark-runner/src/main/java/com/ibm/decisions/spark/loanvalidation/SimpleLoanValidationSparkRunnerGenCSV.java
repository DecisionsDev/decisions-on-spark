...
public class SimpleLoanValidationSparkRunnerGenCSV {
	...
	public static void main(String[] args) {
		...
		//String requestFileName = "https://raw.githubusercontent.com/ODMDev/decisions-on-spark/master/data/loanvalidation/loanvalidation-requests-1K.json";
		String requestFileName = "cos://us-geo/odm1/loanvalidation-requests-1K.json";
		...
		decisionFileName = "data/loanvalidation/10K/loanvalidation-decisions-10K.csv";
		automateDecisions(sc, requestFileName, decisionFileName);
		*/
		...
		decisionFileName = "data/loanvalidation/100K/loanvalidation-decisions-100K.csv";
		automateDecisions(sc, requestFileName, decisionFileName);
		*/
		...
		decisionFileName = "data/loanvalidation/200K/loanvalidation-decisions-200K.csv";
		automateDecisions(sc, requestFileName, decisionFileName);
		*/
	}
	...
	public static void automateDecisions(JavaSparkContext sc, String requestFileName, String decisionFileName) {
		...
		// RDD creation
		JavaRDD<LoanValidationRequest> requestRDD;
		if (false) {
		...
		//
		JavaRDD<String> csvAnswers = decisions.map(serializeDecisionAsCSV).cache();
